...
Another car is cutting just in front, coming from right lane.
...
class CutInFromRightBehind(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(CutInFromRightBehind, self).__init__("CutInFromRightBehind",
                                                   ego_vehicles,
                                                   config,
                                                   world,
                                                   debug_mode,
    ...
    def _create_behavior(self):
        ...
        # lane_change
        lane_change = LaneChange(self.other_actors[0], speed=None, direction='left')
